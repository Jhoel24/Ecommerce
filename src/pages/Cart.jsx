...
import Ropa1 from '../assets/images/ropa1.webp'
import Ropa2 from '../assets/images/ropa2.webp'
...
const Product = styled.div`
    display: flex;
    justify-content: space-between;
    ${mobile({ flexDirection: "column", gap: '.5rem' })}
`
                ...
                <Info>
                    <Product>
                        <ProductDetail>
                            <Image src={Ropa1} />
                            <Details>
                                <ProductName><b>Product: </b> JESSIE THUNDER JACKET</ProductName>
                                <ProductId><b>ID: </b> 38948948bdc</ProductId>
